    ...
    extend: {
      ...
      colors: {
        ...
        travel: {
          ...
          "coral-light": "hsl(var(--travel-coral-light))",
          green: "hsl(var(--travel-green))",
          "green-light": "hsl(var(--travel-green-light))",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": {
            boxShadow: "0 0 20px hsl(var(--travel-coral) / 0.4)",
          },
          "50%": {
            boxShadow: "0 0 30px hsl(var(--travel-coral) / 0.6)",
          },
        },
      },
      animation: {
