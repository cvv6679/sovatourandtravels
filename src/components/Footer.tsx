      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/blog" className="text-background/70 hover:text-secondary text-sm transition-colors">
                  Blog
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-background/10 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            <Link to="/privacy-policy" className="text-background/50 hover:text-background/70 text-sm transition-colors">
              Privacy Policy
            </Link>
            <Link to="/refund-policy" className="text-background/50 hover:text-background/70 text-sm transition-colors">
              Refund Policy
            </Link>
            <Link to="/terms-conditions" className="text-background/50 hover:text-background/70 text-sm transition-colors">
              Terms & Conditions
            </Link>
            <Link to="/admin/login" className="text-background/50 hover:text-background/70 text-sm transition-colors">
              Admin
            </Link>
          </div>
        </div>
