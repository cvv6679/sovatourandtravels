...
import { ArrowLeft, Calendar, Clock, MapPin, Lightbulb, Phone, Camera } from "lucide-react";
          ...
          <div className="flex flex-wrap gap-6 justify-center">
            <div className="flex items-center gap-2 text-muted-foreground">
              ...
              <div>
                ...
                <span className="font-semibold text-card-foreground">{destination.bestTime}</span>
              </div>
            </div>
            <div className="flex items-center gap-2 text-muted-foreground">
              ...
              <div>
                ...
                <span className="font-semibold text-card-foreground">{destination.idealDuration}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
            {destination.topSpots.map((spot, i) => (
              ...
              >
                <img src={spot.image} alt={spot.name} className="w-full h-48 object-cover" loading="lazy" />
                <div className="p-5">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-primary-foreground/80 mb-8">
              Let us craft the perfect {destination.name} itinerary for you. No hidden costs, fully customizable.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href={`https://wa.me/919474025173?text=Hi, I want to plan a trip to ${destination.name}. Please share details.`}
                target="_blank"
              ...
              <Link to="/contact">
                <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-foreground font-semibold">
                  Send Inquiry
                </Button>
              </Link>
            </div>
